public class Atividade01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("raiz: "+Math.pow(64, 0.5));
		
		System.out.println("raiz com exp e log e realint: "+(int)Math.sin(64*0.5));
		
		System.out.println("raiz com exp e log sem realint: "+Math.sin(64*0.5));
		
		System.out.println("formatar "+Math.sin(45*3.14/180));
		
		System.out.println("potencia com operador ** e formatar: "+Math.pow(8,3.3));
		
		System.out.println("raiz cubica: "+Math.pow(8,0.333));
